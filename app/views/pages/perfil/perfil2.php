                    ...
                    <div class="container-principal-informacion-usuario">
                        <div class="container-style-main">
                            <?php if ($datos['usuario']->idusuario == $_SESSION['logueado']) : ?>
                                ...
                                <br>
                                <div class="container-usuario-publicar">
                                    <h3>Colocar las piblicaciones del usuario logueado</h3>
                                </div>
                            <?php endif ?>
                            <!-- Publicaciones del usuario del perfil -->
                            <?php if ($datos['usuario']->idusuario !== $_SESSION['logueado']) : ?>
                                <div class="container-usuario-publicar">
                                   <h3>***Colocar las piblicaciones de este usuario***</h3>
                                </div>
                            <?php endif ?>

                        </div>
                    </div>
                <!-- Todas las publicaiones de este usario -->
