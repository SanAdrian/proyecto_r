                        ...
                        <div class="content-completar-perfil center">
                            <form action="<?php echo URL_PROJECT ?>/home/insertarRegistrosPerfil" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <div class="center">
                                        <input type="button" value="Mi Ubicación" onclick="getMyPosition()" class="btn-green btn-separate" id="btnMiUbicacion"> <!-- Boton Mi Ubicación -->
                                        <input type="button" value="   Mi Centro   " onclick="getMyCenterPosition()" class="btn-gray btn-separate" id="btnMiCentro" disabled="true"> <!-- Boton Mi Centro -->
                                    </div>
